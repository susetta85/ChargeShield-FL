...
question this paper studies, not an assumption it makes. (In other words: We do not rely on theory to claim that “the system is 100\% secure for every individual charging session simply because we use DP.” Differential Privacy here protects the client-level dataset. Understanding how much effective protection extends to an individual charging session is precisely the empirical question this paper aims to answer through real-world attacks.)
